    ...
    <div class="row my-3">
            ...
            <div class="news">
				<a href="#">
					...
					<div class="news-title flex-column d-flex align-items-start justify-content-end">
						<h4 class="col-12 p-0">Tieu de tin tuc acs mbcx aswTieu de tin tuc acs mbcx aswTieu de tin tuc acs mbcx asw</h4>
						<span>Tieu de tin tuc acs mbcx aswTieu de tin tuc acs mbcx asw</span>
					</div>
				</a>
			</div>
        </div>
        <div class="col-12 col-sm-4">
            <div class="news news-r">
                <div class="news-photo" style="background-image: url(images/hang-01/messi.jpg)"></div>
                <div class="news-title flex-column d-flex align-items-start justify-content-end">
                    <b class="col-12 p-0">Tieu de tin tuc acs mbcx aswTieu de tin tuc acs mbcx asw</b>
                </div>
            </div>
            <div class="news news-r">
                <div class="news-photo" style="background-image: url(images/hang-01/messi.jpg)"></div>
