...
<div class="container">
    <div class="row my-3">
		<?php
		$sqlbongda = "SELECT * FROM tintucbongda WHERE KhuVucBongDa = 5 ORDER BY MaTinTucBongDa DESC";
		...
		$sqlbongro = "SELECT * FROM tintucbongda WHERE KhuVucBongDa = 5 ORDER BY MaTinTucBongDa DESC LIMIT 1, 2";
	 ...
	 <div class="row">
		...
		$sqlvothuat = "SELECT * FROM tintucbongda WHERE KhuVucBongDa = 5 ORDER BY MaTinTucBongDa DESC LIMIT 3, 4";
