...
//get nameimage
       ...
       // if (empty($MoTa)) { array_push($errors, "chưa có mô tả công việc"); }
		...
		if (file_exists($_FILES['videobongda']['tmp_name'])) {
			...
			$query = "INSERT INTO tintucbongda (TieuDeBongDa, PhuDeBongDa, ImageBongDa, VideoBongDa, ChiTietBongDa, NgayDangBongDa, KhuVucBongDa ) 
  			  VALUES('$titlebongda', '$subtitlebongda', '/images/$filename','/images/$filename1','$descriptionbongda', '$ngaydangbongda','$khuvuc')";
