...
<div class="container">
    <div class="row my-3">
		<?php
		$sqlbongda = "SELECT * FROM tintucbongro WHERE GiaiBongRo = 4 ORDER BY MaTinTucBongRo DESC";
		...
		$sqlbongro = "SELECT * FROM tintucbongro WHERE GiaiBongRo = 4 ORDER BY MaTinTucBongRo DESC LIMIT 1, 2";
	 ...
	 <div class="row">
		...
		$sqlvothuat = "SELECT * FROM tintucbongro WHERE GiaiBongRo = 4 ORDER BY MaTinTucBongRo DESC LIMIT 3, 4";
